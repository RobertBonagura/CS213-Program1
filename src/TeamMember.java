   ...
   */
   ...
   public static void main(String [] args)
   {
      ...
      if(!teamMember1.name.equals("Name1"))
         System.out.println("Test #1) Constructor-1: failed. name = " + teamMember1.name + " : Expected value = Name1");
      else
         System.out.println("Test #1) Constructor-1: Passed");
      if(!teamMember1.startDate.equals(new Date("1/1/2020")) )
         System.out.println("Test #2) Constructor-2: failed. date = " + teamMember1.startDate.toString() + 
      ...
      if(!teamMember1.getStartDate().equals(teamMember1.startDate))
         System.out.println("Test #3) getStartDate()-1: failed. Value of date returned by getStartDate() = " +
      ...
      if(!teamMember1.getName().equals(teamMember1.name))
         System.out.println("Test #4) getName()-1: failed, value of name returned by getName() = " +
      ...
      if(!teamMemberA.equals(teamMemberA))
         System.out.println("Test #5) equals()-1: failed. a teamMember is not equal to itself");
      else
         System.out.println("Test #5) equals()-1: Passed");
      if(teamMemberA.equals(teamMemberB))
         System.out.println("eTest #6) equals()-2: failed. Returned true when dates are not equivalent");
      else
         System.out.println("Test #6) equals()-2: Passed");
      if(teamMemberA.equals(teamMemberC))
         System.out.println("Test #7) equals()-3: failed. Returned true when names are not equivalent");
      else
         System.out.println("Test #7) equals()-3: Passed");
      
      //toString() Tests
      if(!teamMember1.toString().equals("Name1 1/1/2020"))
         System.out.println("Test #8) toString()-1: failed. Returned string = " + teamMember1.toString() +
